...
/**
 * Servlet implementation class GetAllCourseSrv
 */
@WebServlet("/GetAllCourseSrv")
public class GetAllCourseSrv extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetAllCourseSrv() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getSession().setAttribute("coursesdata", courses);
