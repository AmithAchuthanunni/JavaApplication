...
/**
 * Servlet implementation class UpdateCourseSrv
 */
...
public class UpdateCourseSrv extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		CourseBean course=dao.getCourseDetails(cname);
		
		request.getSession().setAttribute("coursedata1", course);
		
		response.sendRedirect("cupdate.jsp");
